...
router.get("/getFavoritesResourcesByUser/:userId", authenticate, getFavoritesResourcesByUser);
router.post("/rateResource", authenticate, rateResource);

// Admin routes
router.post("/createResource", authenticate, authorize("admin"), schemaValidator(resourceSchema), createResource);
router.put(
  "/updateResource/:id",
  authenticate,
  authorize("admin"),
...
router.delete("/deleteResource/:id", authenticate, authorize("admin"), deleteResource);
